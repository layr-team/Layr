...
// aes-256-ctr is the one recommended by the node.js community, pass in the function `crypto.createCipher`
const algorithm = 'aes-256-ctr';  // TODO: need to pass iv and use Cipheriv later

const fs = require('fs');
// zip the large file
const zlib = require('zlib');

const filepath = 'orgexp.txt';
