...
/*kadnode2.join([kadnode1.identity, kadnode1.contact], () => {
  kadnode2.getOtherBatNodeContact([kadnode1.identity.toString(), kadnode1.contact], (err,res) => {
    console.log(err, res)
  })
})
*/
...
//kadnode2.getOtherBatNodeContact([kadnode1.identity.toString(), kadnode1.contact], (err, res) => {console.log(err,res)})
